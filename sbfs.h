...
#define INODE_NMBR_PER_BLOCK (SBFS_BLOCK_SIZE/sizeof(struct sbfs_inode))
...
#define NUMER_OF_DATA_BITMAP_BLOCKS 4
#define NUMBER_OF_BITMAP_BLOCKS NUMBER_OF_INODE_BITMAP_BLOCKS+NUMER_OF_DATA_BITMAP_BLOCKS
